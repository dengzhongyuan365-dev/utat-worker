...
def normalize_payload(payload: Mapping[str, Any]) -> Dict[str, Any]:
    ...
    out["repo"] = pick(data.get("repo"), source.get("repo"), source.get("url"))
    out["branch"] = pick(data.get("branch"), source.get("branch"), default="master")
    out["commit"] = pick(data.get("commit"), source.get("commit"), default="")
    out["project_root"] = pick(data.get("project_root"), source.get("project_root"), default="")
    ...
    out["test_script"] = pick(data.get("test_script"), test.get("script"), default="")
    out["test_command"] = pick(data.get("test_command"), test.get("command"), default="")
